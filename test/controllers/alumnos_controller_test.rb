...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { apellido: @alumno.apellido, cedula: @alumno.cedula, correo: @alumno.correo, nombre: @alumno.nombre, telefono: @alumno.telefono }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { apellido: @alumno.apellido, cedula: @alumno.cedula, correo: @alumno.correo, nombre: @alumno.nombre, telefono: @alumno.telefono }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
